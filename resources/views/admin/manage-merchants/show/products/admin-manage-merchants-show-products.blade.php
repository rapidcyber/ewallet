                        ...
                        <x-table.standard.row wire:key="{{ $product->id }}">
                            ...
                            <x-table.standard.td class="w-52 min-w-52 max-w-52 2xl:w-72 2xl:min-w-72 2xl:max-w-72">
                                <div class="flex items-center w-full gap-1">
                                    ...
                                    <div class="w-max">
                                        <a  href="{{ route('admin.manage-merchants.show.products.details', ['merchant' => $merchant, 'product' => $product]) }}"><x-icon.chevron-right class="w-full" /></a>
                                    </div>
                                </div>
                            </x-table.standard.td>
        ...
        <x-modal.confirmation-modal title="Confirmation">
            ...
            <x-slot:action_buttons>
                <x-button.outline-button
                    ...
                    @click="confirmationModal.visible=false;$set('product_id',null)" color="primary" class="w-1/2">Go
