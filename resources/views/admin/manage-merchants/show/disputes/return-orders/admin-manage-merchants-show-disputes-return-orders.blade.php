                    ...
                    <div class="flex flex-col justify-center w-4/12 p-4">
                        <div class="flex flex-col gap-2">
                            <p class="text-rp-neutral-500">Paid Price + Shipping Fee: <span
                                    ...
                                    {{ \Number::currency($return_order->product_order->amount + $return_order->product_order->shipping_fee, 'PHP') }}</span>
                            </p>
                    ...
                    <div class="flex items-center w-5/12">
                        <div class="flex flex-row justify-between items-center w-full">
                            ...
                            <div class="cursor-pointer">
                                <a
                                    href="{{ route('admin.manage-merchants.show.disputes.return-orders.details', [
                                        'merchant' => $merchant,
