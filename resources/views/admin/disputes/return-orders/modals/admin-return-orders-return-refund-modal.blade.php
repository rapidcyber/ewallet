<x-modal x-model="$wire.visible">
    <div
        ...
        <div class="grid grid-cols-2 gap-3">
            <x-button.outline-button @click="$wire.visible=false;$dispatch('closeModal')" wire:target="return_refund" wire:loading.attr="disabled"
                wire:loading.class="opacity-50" color="primary">Cancel</x-button.outline-button>
            <x-button.filled-button wire:click="return_refund" wire:target="return_refund" wire:loading.attr='disabled'
