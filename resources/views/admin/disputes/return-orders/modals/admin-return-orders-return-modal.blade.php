<x-modal x-model="$wire.visible">
    <div
        ...
        {{-- HEADING --}}
        <div>
            <h3 class="text-2xl font-bold mb-2">Return Only</h3>
        </div>
        ...
        <div class="grid grid-cols-2 gap-3">
            <x-button.outline-button @click="$wire.visible=false;$dispatch('closeModal')" wire:target="return" wire:loading.attr="disabled"
                wire:loading.class="opacity-50" color="primary">Cancel</x-button.outline-button>
            <x-button.filled-button wire:click="return" wire:target="return" wire:loading.attr='disabled'
