<x-main.content>
    <x-main.action-header>
        ...
        <x-slot:actions>
            <x-button.filled-button href="{{ route('merchant.seller-center.disputes.create', ['merchant' => $merchant]) }}">file a dispute</x-button.filled-button>
        </x-slot:actions>
    </x-main.action-header>

    <div class="grid grid-cols-1 gap-3 mb-8">
        <x-card.filter-card label="Transaction Disputes" data="{{ $this->transaction_disputes_count }}" :isActive="true" />
    </div>
                    ...
                    <x-table.rounded.row>
                        ...
                        <x-table.rounded.td>
                            <div class="flex items-center justify-between">
                                ...
                                @endswitch
                                <a  href="{{ route('merchant.seller-center.disputes.show', ['merchant' => $merchant, 'transactionDispute' => $dispute->id]) }}"
