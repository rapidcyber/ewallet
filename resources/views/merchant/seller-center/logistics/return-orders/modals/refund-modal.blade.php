<div class="absolute flex flex-col gap-8 bg-white p-10 rounded-2xl w-[1180px] max-w-[90%] max-h-[95%] overflow-y-auto">
    ...
    <div class="grid grid-cols-2 gap-3">
        <x-button.outline-button @click="$dispatch('closeModal')" wire:target="refund" wire:loading.attr="disabled"
            wire:loading.class="opacity-50">Cancel</x-button.outline-button>
        <x-button.filled-button wire:click="refund" wire:target="refund" wire:loading.attr='disabled' :disabled="$button_clickable == false">Confirm</x-button.filled-button>
    </div>
