...
class MerchantInvoices extends Component
{
    ...
    protected $allowedStatus = ['', 'paid', 'partial', 'unpaid'];
    ...
    public function render()
    {
        ...
        $unpaidCount = $this->merchant->outgoing_invoices()->where('status', 'unpaid')->whereBetween('created_at', [$date['fromDate'], $date['toDate']])->count();
