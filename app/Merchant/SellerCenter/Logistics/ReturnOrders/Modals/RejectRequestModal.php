...
class RejectRequestModal extends Component
{
    ...
    public function reject_request()
    {
        ...
        $log->description = "Merchant rejected the return request. Reason: {$this->get_rejection_reasons->where('slug', $this->reason)->first()->name}";
        ...
        try {
            ...
            DB::rollBack();
            Log::error("RejectRequestModal.reject_request: {$th->getMessage()}");
    ...
    {
        return view('merchant.seller-center.logistics.return-orders.modals.reject-request-modal');
    }
}
